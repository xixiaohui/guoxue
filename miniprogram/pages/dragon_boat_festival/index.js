// pages/dragon_boat_festival/index.js - 端午诗词专题
...
Page({
  ...
  onLoad() {
    const topic = festivalData.getFestival('dragon_boat');
  ...
  onShareAppMessage() {
    ...
    return {
      title: first ? `端午诗词｜${first.title} · ${first.author}｜超然古诗词` : '端午诗词 · 超然古诗词',
      path: '/pages/dragon_boat_festival/index'
    };
  },
