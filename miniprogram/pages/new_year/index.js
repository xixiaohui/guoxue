// pages/new_year/index.js - 除夕诗词专题
...
Page({
  ...
  onLoad() {
    const topic = festivalData.getFestival('new_year');
  ...
  onShareAppMessage() {
    ...
    return {
      title: first ? `除夕诗词｜${first.title} · ${first.author}｜超然古诗词` : '除夕诗词 · 超然古诗词',
      path: '/pages/new_year/index'
    };
  },
