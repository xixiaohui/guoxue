...
// ─── 变现相关常量 ────────────────────────────────────
const MONETIZE = {
  FREE_DAILY_LIMIT: 5,          // 免费每日配额
  REWARDED_AD_ID: 'adunit-513a37c7d48cdf7f',  // 激励视频广告位
  BANNER_AD_ID: 'adunit-513a37c7d48cdf7f',    // Banner广告位（实际应申请独立）
  VIP_PRICE_1MONTH: 9.9,        // 月费
  VIP_PRICE_3MONTH: 24.9,       // 季费
  VIP_PRICE_12MONTH: 79,        // 年费
};
...
const STORAGE_KEYS = {
  ...
  QUOTA_CACHE: 'quota_cache',   // 配额本地缓存
};
...
// ─── 本地存储键名 ────────────────────────────────────
const STORAGE_KEYS = {
  DAILY_PREFIX: 'daily_',          // 每日经典缓存（按日期）
  DAILY_IDIOM_PREFIX: 'daily_idiom_', // 每日成语缓存
  TRANSLATE_HISTORY: 'trans_history',
  CHAT_HISTORY: 'chat_history',
  FAVORITES_POEM: 'fav_poems',
  FAVORITES_IDIOM: 'fav_idioms',
...
// ─── Tab 页路径（switchTab 与 navigateTo 区分） ────────────────────────────────────
const TAB_PAGES = [
  '/pages/home/index',
  '/pages/chat/index',
  '/pages/translate/index',
